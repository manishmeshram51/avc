...
template<unsigned PER_INCH> const LengthUnit<PER_INCH> operator+(LengthUnit<PER_INCH> left, LengthUnit<PER_INCH> right)
{
  return LengthUnit<PER_INCH>(left.m_value + right.m_value);
}

template<unsigned PER_INCH> const LengthUnit<PER_INCH> operator*(LengthUnit<PER_INCH> left, int right)
{
  return LengthUnit<PER_INCH>(left.m_value * right);
}

template<unsigned PER_INCH> const LengthUnit<PER_INCH> operator*(int left, LengthUnit<PER_INCH> right)
{
  return right * left;
}
